...
# Parsing + Configuration Script – TOPFLY_GEAR - Rev. A

This **Parsing + Configuration** script is designed for the **TOPFLY_GEAR** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – TOPFLY_GEAR Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **TOPFLY_GEAR** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
